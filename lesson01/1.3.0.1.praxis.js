...
{"ru": "Светлячок", "ar": "يَرَاعة", "audio": "audio/يراعة.mp3"},
  ...
  {"ru": "Хумус/нут", "ar": "حُمُّص", "audio": "audio/حمص.mp3"},
    ...
    function loadWritingWord() {
      currentWord = getRandomWord();
  
      document.getElementById("word-arabic").textContent = currentWord.ar;
      document.getElementById("userInput").value = "";
      document.getElementById("userInput").className = "input-arabic";
    ...
    function checkInput() {
      ...
      const correct = currentWord.ar.trim();
      const result = [];
      ...
      for (let i = 0; i < correct.length; i++) {
        ...
        if (userChar === correctChar) {
          result.push(`<span style="color: green;">${correctChar}</span>`);
        } else {
          result.push(`<span style="color: red;">${userChar || "□"}</span>`);
      ...
      document.getElementById("resultText").innerHTML = isFullyCorrect
        ? `✅ Верно! <span style="font-size: 28px;">${resultHTML}</span>`
        : `<span style="font-size: 28px;">${resultHTML}</span>`;
    ...
    // Запускаем первый вопрос при загрузке
    window.onload = loadWritingWord;
